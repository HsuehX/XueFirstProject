...
public class CommonSpinComplexAdapter extends BaseAdapter {
    ...
    public CommonSpinComplexAdapter(Context context, List<SpannerDialogBean> list, int theme) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CommonSpinComplexAdapter.ViewHolder holder;

        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_common_dialog_spin, null);
            holder = new CommonSpinComplexAdapter.ViewHolder();
            ...
            holder = (CommonSpinComplexAdapter.ViewHolder) convertView.getTag();
        }

//        holder.mTextView.setText(mList.get(position).getValue());
    ...
    public void notifiDataSetAllChanged(List<SpannerDialogBean> list) {
        if (mList != null) {
            mList.clear();
            mList.addAll(list);
            notifyDataSetChanged();
