...
public class DrawingActivity extends Activity implements View.OnClickListener {
    private final static String TAG = DrawingActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTf = Typeface.createFromAsset(getAssets(), "font/世界那么大.ttf");

//        mTf = Typeface.createFromAsset(this.getAssets(),"font/世界那么大.ttf");
